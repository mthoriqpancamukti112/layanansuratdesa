    ...
    <div class="container">
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                <td colspan="3" align="center"><strong>
                        <font size=5 color="black"><br><u>SURAT KETERANGAN PENGHASILAN ORANG TUA</u></font>
                    </strong><br>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td class="text-cell">Sepanjang sepengetahuan kami orang tersebut diatas tergolong tidak mampu.
                </td>
            </tr>
            <tr>
                <td class="number-cell">3.</td>
                <td class="text-cell">Yang bersangkutan mempunyai penghasilan kurang dari
                    {{ 'Rp ' . number_format($suratPenduduk->detailSurats->first()->jumlah_penghasilan, 0, ',', '.') }}
                    /Bulan.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">Syarat keperluan ini dipergunakan untuk
                    "{{ $suratPenduduk->detailSurats->first()->keperluan }}".</td>
            </tr>
            <tr>
                <td style="padding-bottom: 5px"></td>
            </tr>
